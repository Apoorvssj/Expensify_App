...
export const startAddExpense = (expenseData = {}) => {
    ...
    //this function is internally called by redux with dispatch,and is also callled with getState which we can use to get current state
    return (dispatch, getState) => {
        const uid = getState().auth.uid;//getting current logged in user id
...
export const startRemoveExpense = ({id} = {}) => {
    return (dispatch, getState) => {
        ...
        //retuning to promise chain in test cases 
